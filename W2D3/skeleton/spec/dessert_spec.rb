...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("ice cream", "scoop", "Arturo") }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["chocolate", "cookie dough", "m&ms", "mint", "cheerio"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef has made 1 ice creams!")
    end
  end
